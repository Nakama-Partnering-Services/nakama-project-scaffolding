module.exports = {
	...
	// Note: locally, we use severity-threshold 'Moderate' to catch more issues, same level is applied in pipeline jobs
	...
	// Note: locally, we use --failon 'warning' to catch more issues, same level is applied in pipeline jobs
